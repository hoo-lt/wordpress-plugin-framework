...
readonly class ResponseBuilder implements ResponseBuilderInterface
{
	...
	{
		return new static($this->bodyFactory, $this->headersFactory, $this->uuid, $statusCode, $this->headers, $this->body);
	}
	...
	public function withHeader(string $name, string $value): static
	{
		...
		return new static($this->bodyFactory, $this->headersFactory, $this->uuid, $this->statusCode, $headers, $this->body);
	}
	...
	public function withBody(mixed $body): static
	{
		...
		return new static($this->bodyFactory, $this->headersFactory, $this->uuid, $this->statusCode, $this->headers, $body);
	}

	public function withoutBody(): static
	{
		return new static($this->bodyFactory, $this->headersFactory, $this->uuid, $this->statusCode, $this->headers, null);
	}
