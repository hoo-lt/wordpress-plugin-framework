...
readonly class RequestBuilder implements RequestBuilderInterface
{
	...
	{
		return new static($this->bodyFactory, $this->headersFactory, $this->urlFactory, $method, $this->url, $this->headers, $this->body);
	}

	public function withUrl(string $url): static
	{
		return new static($this->bodyFactory, $this->headersFactory, $this->urlFactory, $this->method, $url, $this->headers, $this->body);
	}
	...
	public function withHeader(string $name, string $value): static
	{
		...
		return new static($this->bodyFactory, $this->headersFactory, $this->urlFactory, $this->method, $this->url, $headers, $this->body);
	}
	...
	public function withBody(mixed $body): static
	{
		...
		return new static($this->bodyFactory, $this->headersFactory, $this->urlFactory, $this->method, $this->url, $this->headers, $body);
	}

	public function withoutBody(): static
	{
		return new static($this->bodyFactory, $this->headersFactory, $this->urlFactory, $this->method, $this->url, $this->headers, null);
	}
