...
/**
 * Legacy dot-path, array-only key/value helper.
 *
 * Preserved for reference/rollback while the codebase migrates to the
 * Symfony-style, type-deterministic {@see Helper}. Not wired anywhere.
 */
readonly class OldHelper
{
